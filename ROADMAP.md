...
1. Done: receive one source-backed inquiry that lacks a better existing owner
   (`SFQ-0001` from CAI Systemic Failure).
2. Done: admit one bounded synthetic candidate (`CMD-0001`) with alternatives
   and stops.
