...
Prefer synthetic, reversible, least-consequential tests. A proving plan states
what could falsify the candidate, permitted conclusions, affected-party standing,
stop conditions, data boundary, recovery, and who owns the result. No repository
has a standing obligation to serve as proving ground.
...
- `LEAST-CONSEQUENTIAL-PROVING-SCORE-AUTHORITY-DEVIATION-BOUNDARY-FIXTURE.md`
  applies that score boundary to a validated synthetic trace where an
...
- `LEAST-CONSEQUENTIAL-PROVING-SCORE-VALIDATION-CONFLICT-BOUNDARY-FIXTURE.md`
  ...
  or P8.
- `LEAST-CONSEQUENTIAL-PROVING-SCORE-CONFLICTING-OBSERVATIONS-BOUNDARY-FIXTURE.md`
  applies the score boundary to an authorized clean synthetic trace containing
...
- `LEAST-CONSEQUENTIAL-PROVING-SCORE-UNAUTHORIZED-RECONCILIATION-BOUNDARY-FIXTURE.md`
  ...
  disposition or P8.
- `LEAST-CONSEQUENTIAL-PROVING-SCORE-PARTIAL-SUPERSESSION-BOUNDARY-FIXTURE.md`
  applies valid result-owner supersession to exactly one of two direct
...
- `LEAST-CONSEQUENTIAL-PROVING-SCORE-POST-REGRANT-REVOCATION-AUTHORITY-BOUNDARY-FIXTURE.md`
  preserves both valid records through the distinct regrant's future-only
  revocation, keeps the attempted post-revocation record as negative evidence,
  and leaves the surviving evidence all-`equal` with `bounded_pass`, `defer`,
  and no P8.
- `LEAST-CONSEQUENTIAL-PROVING-SCORE-SECOND-REGRANT-AFTER-REVOCATION-AUTHORITY-BOUNDARY-FIXTURE.md`
  preserves the full two-grant and two-revocation lineage, then adds a second
...
- `CANDIDATE-REVISION-SYNTHETIC-P8-SCORED-NO-DISPOSITION-AUTHORITY-BOUNDARY-FIXTURE.md`
  preserves that complete execution-and-observation lineage and consumes one
  exact scoring authority to reach
...
- `CANDIDATE-REVISION-SYNTHETIC-P8-REVISION-CORRECTION-VALIDATED-NO-REAL-CANDIDATE-CHANGE-BOUNDARY-FIXTURE.md`
  preserves that correction receipt, negative evidence, and
...
- `CANDIDATE-REVISION-SYNTHETIC-P8-CORRECTED-RESULT-ACCEPTED-NO-REAL-CANDIDATE-CHANGE-BOUNDARY-FIXTURE.md`
  preserves that acknowledgment, negative evidence, and
